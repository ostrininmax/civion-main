...
const extraEn: Dictionary = {
  ...
  'demo.tour.step2.body': 'This permit expires soon. Open details for renewal and proof.',
  'demo.tour.step3.title': 'Rights and share controls',
  'demo.tour.step3.body': 'Rights come from this document and sharing stays minimal.',
  'demo.tour.step4.title': 'Open Civic Card',
  'demo.tour.step4.body': 'Open the BenefitPass card to present proof instantly.',
  'demo.tour.step5.title': 'Rotating QR proof',
  'demo.tour.step5.body': 'QR rotates automatically and shares minimal data by default.',
  'demo.tour.step6.title': 'Verifier validation',
  'demo.tour.step6.body': 'Verifier checks token validity and sees only required fields.',
  'demo.tour.step7.title': 'Trusted audit trail',
  'demo.tour.step7.body': 'Verification instantly updates notifications, timeline, and audit.',
  'demo.tour.step8.title': 'BenefitPass value',
  'demo.tour.step8.body': 'BenefitPass cuts queues and paperwork with instant proof.',
  'demo.tour.skip': 'Skip',
...
const extraRu: Dictionary = {
  ...
  'demo.tour.description': 'Короткий проход по ключевому сценарию проверки.',
  'demo.tour.step1.title': 'Синхронизация реестра',
  'demo.tour.step1.body': 'Документы подтягиваются из госреестров в режиме только чтения.',
  'demo.tour.step2.title': 'Скоро истекающий ВНЖ',
  'demo.tour.step2.body': 'Откройте детали ВНЖ для продления и проверки.',
  'demo.tour.step3.title': 'Права и шаринг',
  'demo.tour.step3.body': 'Права связаны с документом, а шаринг остается минимальным.',
  'demo.tour.step4.title': 'Открытие Civic Card',
  'demo.tour.step4.body': 'Откройте BenefitPass и покажите подтверждение мгновенно.',
  'demo.tour.step5.title': 'Ротация QR',
  'demo.tour.step5.body': 'QR обновляется автоматически и по умолчанию скрывает лишние данные.',
  'demo.tour.step6.title': 'Проверка верификатором',
  'demo.tour.step6.body': 'Верификатор видит только обязательные поля и срок действия.',
  'demo.tour.step7.title': 'Доверенный аудит',
  'demo.tour.step7.body': 'Событие сразу попадает в уведомления, таймлайн и аудит.',
  'demo.tour.step8.title': 'Ценность BenefitPass',
  'demo.tour.step8.body': 'Меньше очередей и бумаг за счет мгновенного доказательства права.',
